...
public class MultiplyEquationGenerator implements GenerationStrategy {
    @Override
    public Equation generate(int generatorFactor) {
        ...
        num1 = Utils.getNumberInRange(0, 5 + 3 * generatorFactor);
        num2 = Utils.getNumberInRange(0, 6 + 3 * generatorFactor);
